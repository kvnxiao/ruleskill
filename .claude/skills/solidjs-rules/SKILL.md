---
name: solidjs-rules
description: "Use for SolidJS implementation and review: reactivity, components and props, control flow, stores and state, data fetching, lifecycle and refs, testing, TypeScript, and React-to-Solid migration."
paths: "**/*.tsx,**/*.jsx,**/*.ts,**/*.js"
---

# SolidJS Rules

Use for SolidJS implementation and review: reactivity, components and props, control flow, stores and state, data fetching, lifecycle and refs, testing, TypeScript, and React-to-Solid migration.
