...
- [Failure propagation example](references/typescript-failure-examples.md): Read when a worked example would clarify failure propagation, audience-specific rendering, or structural recognition.
- [Cancellation ownership example](references/typescript-cancellation-example.md): Read when a worked example would clarify abort reasons, replacement ownership, or cancellation race tests.
