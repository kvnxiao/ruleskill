...
- [Testing](references/pi-testing.md): Read when testing domain contracts, event ordering, recovery and retry, Pi lifecycle transitions, tool execution, or package installation.
